...
execution/builtins_management/ft_env.o execution/builtins_management/ft_exit.o execution/define_non_reiterative_path/manage_absolute_path_utils.o \
execution/define_non_reiterative_path/manage_absolute_path.o execution/define_non_reiterative_path/define_non_reiterative_path.o \
execution/executables_management/manage_executables.o execution/redirection_management/redirection_management.o \
execution/command_execution/run_simple_command.o execution/command_execution/create_pipe_and_pib_lists.o execution/command_execution/manage_subshell.o \
