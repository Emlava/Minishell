...
EXEC_OBJECTS = execution/prompt_management/manage_prompt.o execution/env_management/env_utils.o execution/builtins_management/builtins.o execution/builtins_management/ft_echo.o \
execution/builtins_management/ft_cd.o execution/define_non_reiterative_path/define_non_reiterative_path.o execution/executables_management/manage_executables.o \
